import {SampleTestFS} from '../Renderer/Shaders/SampleTestFS.js';
import {SampleTestVS} from '../Renderer/Shaders/SampleTestVS.js';
...
export default {
    ...
    updateCapabilities(renderer) {
        ...
        const glVertexShader = _WebGLShader(renderer, gl.VERTEX_SHADER, SampleTestVS.theWord());

        let fragmentShader = `#define SAMPLE ${maxTexturesUnits}\n`;
        fragmentShader += SampleTestFS.theWord();
