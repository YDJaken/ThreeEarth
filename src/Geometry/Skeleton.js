...
/*function Skeleton( bones, boneInverses ) {
	...
	if ( boneInverses === undefined ) {
		...
		if ( this.bones.length === boneInverses.length ) {
			...
			console.warn( 'Speed3DEngine.Skeleton boneInverses is the wrong length.' );
...
class Skeleton {
    ...
    update() {
        ...
        let that = this;
        return (function update() {
            let bones = that.bones;
            let boneInverses = that.boneInverses;
            let boneMatrices = that.boneMatrices;
            let boneTexture = that.boneTexture;
            // flatten bone matrices to array
