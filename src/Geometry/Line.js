...
/*function Line( geometry, material, mode ) {
	...
	if ( mode === 1 ) {
		...
		console.warn( 'Speed3DEngine.Line: parameter Speed3DEngine.LinePieces no longer supported. Created Speed3DEngine.LineSegments instead.' );
		...
		return function computeLineDistances() {
			...
			if ( geometry.isBufferGeometry ) {
				...
				if ( geometry.index === null ) {
					...
					console.warn( 'Speed3DEngine.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.' );
...
class Line extends Object3D {
    constructor(geometry = new BufferGeometry(), material = new LineBasicMaterial({color: Math.random() * 0xffffff}), mode) {
        if (mode === 1) {
            console.warn('Speed3DEngine.Line: parameter Speed3DEngine.LinePieces no longer supported. Created Speed3DEngine.LineSegments instead.');
            return new LineSegments(geometry, material);
        }
