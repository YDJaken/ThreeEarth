...
/*function Matrix3() {
	...
	if ( arguments.length > 0 ) {
		...
		console.error( 'Speed3DEngine.Matrix3: the constructor no longer reads arguments. use .set() instead.' );
...
Object.assign( Matrix3.prototype, {
	...
	getInverse: function ( matrix, throwOnDegenerate ) {
		...
		if ( matrix && matrix.isMatrix4 ) {
			...
			console.error( "Speed3DEngine.Matrix3: .getInverse() no longer takes a Matrix4 argument." );
		...
		if ( det === 0 ) {
			...
			var msg = "Speed3DEngine.Matrix3: .getInverse() can't invert matrix, determinant is 0";
...
class Matrix3 {
    ...
    getInverse(matrix, throwOnDegenerate) {
        ...
        let me = matrix.elements,
            ...
            det = n11 * t11 + n21 * t12 + n31 * t13;
        if (det === 0) {
            let msg = "Speed3DEngine.Matrix3: .getInverse() can't invert matrix, determinant is 0";
            if (throwOnDegenerate === true) {
                throw new Error(msg);
            } else {
                console.warn(msg);
