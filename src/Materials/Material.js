...
function Material() {
	...
	this.vertexColors = NoColors; // SEDE.NoColors, SEDE.VertexColors, SEDE.FaceColors
	...
	setValues: function ( values ) {
		...
		for ( var key in values ) {
			...
			if ( newValue === undefined ) {
				...
				console.warn( "SEDE.Material: '" + key + "' parameter is undefined." );
				continue;
			...
			if ( key === 'shading' ) {
				...
				console.warn( 'SEDE.' + this.type + ': .shading has been removed. Use the boolean .flatShading instead.' );
			...
			if ( currentValue === undefined ) {
				...
				console.warn( "SEDE." + this.type + ": '" + key + "' is not a property of this material." );
				continue;
...
class Material extends EventDispatcher {
    ...
    toJSON(meta) {
        ...
        // TODO: Copied from Object3D.toJSON
        if (isRoot) {
            let textures = this._extractFromCache(meta.textures);
