...
import {TrianglesDrawMode} from "../src/Core/Constants.js";
...
import {TriangleStripDrawMode} from "../src/Core/Constants.js";

function DRACOLoader(manager = DefaultLoadingManager) {
    this.timeLoaded = 0;
...
DRACOLoader.prototype = {
     ...
     * |attributeName| is the Speed3D.js name of the given attribute type.
    ...
    addAttributeToGeometry: function (dracoDecoder, decoder, dracoGeometry,
        ...
        if (attribute.ptr === 0) {
            console.error('DRACOLoader: No attribute ' + attributeName);
            throw new Error('DRACOLoader: No attribute ' + attributeName);
        }
        ...
        switch (attributeType) {
            ...
            default:
                console.error('DRACOLoader: Unexpected attribute type.');
...
DRACOLoader.decoderPath = './../Loaders/';
