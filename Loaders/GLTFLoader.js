...
import {_Math} from "../src/Datum/Math/Math.js";
import {BufferGeometry} from "../src/Core/BufferGeometry.js";
import {BufferGeometryUtils} from "../Utills/BufferGeometryUtils.js";
...
import {SkinnedMesh} from "../src/Geometry/SkinnedMesh.js";
...
import {DirectionalLight} from "../src/Scene/Lights/DirectionalLight.js";
import {PointLight} from "../src/Scene/Lights/PointLight.js";
import {SpotLight} from "../src/Scene/Lights/SpotLight.js";
import {Line} from "../src/Geometry/Line.js";
import {LineSegments} from "../src/Geometry/LineSegments.js";
import {LineLoop} from "../src/Geometry/LineLoop.js";
...
import {ShaderLib} from "../src/Renderer/Shaders/ShaderLib.js";
import {PointsMaterial} from "../src/Materials/PointsMaterial.js";
import {Material} from "../src/Materials/Material.js";
import {UniformsUtils} from "../src/Renderer/Shaders/UniformsUtils.js";
import {Interpolant} from "../src/Datum/Math/Interpolant.js";
import {Matrix3} from "../src/Datum/Math/Matrix3.js";
...
import {Vector4} from "../src/Datum/Math/Vector4.js";
import {Skeleton} from "../src/Geometry/Skeleton.js";
import {Texture} from "../src/Assets/Texture.js";
import {Scene} from "../src/Scene/Scene.js";
import {Bone} from "../src/Geometry/Bone.js";
...
var GLTFLoader = (function () {
            ...
            if (json.extensionsUsed) {
                ...
                for (var i = 0; i < json.extensionsUsed.length; ++i) {
                    ...
                    switch (extensionName) {
                        ...
                        case "CESIUM_RTC":
                            extensions["CESIUM_RTC"] = json.extensions["CESIUM_RTC"];
                            break;
    ...
    function GLTFBinaryExtension(data) {
        ...
        while (chunkIndex < chunkView.byteLength) {
            if (Math.abs(chunkIndex - chunkView.byteLength) <= 4) break;
    ...
    GLTFDracoMeshCompressionExtension.prototype.decodePrimitive = function (primitive, parser) {
        ...
        for (var attributeName in gltfAttributeMap) {
            ...
            Speed3DAttributeMap[ATTRIBUTES[attributeName]] = gltfAttributeMap[attributeName];
        ...
        return parser.getDependency('bufferView', bufferViewIndex).then(function (bufferView) {
            ...
            return new Promise(function (resolve) {
                ...
                }, Speed3DAttributeMap, attributeTypeMap);
    ...
    var WEBGL_BLEND_FUNCS = {
        ...
        // The followings are not supported by Speed3D.js yet
    ...
    function addMorphTargets(geometry, targets, accessors) {
        ...
        for (var i = 0, il = targets.length; i < il; i++) {
            ...
            if (hasMorphPosition) {
                ...
                // Speed3D.js morph position is absolute value. The formula is
                //   basePosition
    ...
    GLTFParser.prototype.loadTexture = function (textureIndex) {
        ...
        return Promise.resolve(sourceURI).then(function (sourceURI) {
            ...
            if (textureDef.internalFormat !== undefined && texture.format !== WEBGL_TEXTURE_FORMATS[textureDef.internalFormat]) {
                ...
                console.warn('GLTFLoader: Speed3D.js does not support texture internalFormat which is different from texture format. ' +
    ...
    function addPrimitiveAttributes(geometry, primitiveDef, accessors) {
        ...
        for (var gltfAttributeName in attributes) {
            ...
            var Speed3DAttributeName = ATTRIBUTES[gltfAttributeName];
            var bufferAttribute = accessors[attributes[gltfAttributeName]];

            // Skip attributes already provided by e.g. Draco extension.
            if (!Speed3DAttributeName) continue;
            if (Speed3DAttributeName in geometry.attributes) continue;

            geometry.addAttribute(Speed3DAttributeName, bufferAttribute);
