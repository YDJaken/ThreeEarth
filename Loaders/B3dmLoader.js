...
import shaderUtils from '../Renderer/Shaders/ShaderUtils.js';
import Capabilities from '../System/Capabilities.js';
import BatchTableParser from './BatchTableLoader.js';
import utf8Decoder from '../Utills/Utf8Decoder.js';
...
export default {
    /** @module B3dmParser */
    /** Parse b3dm buffer and extract Speed3D.Scene and batch table
     * @function parse
     ...
     * @return {Promise} - a promise that resolves with an object containig a Speed3D.Scene (gltf) and a batch table (batchTable).
     *
     */
