...
$jscomp.polyfill("Promise", function (d) {
    ...
    h.all = function (d) {
        var k = $jscomp.makeIterator(d), r = k.next();
...
var DracoDecoderModule = function (d) {
    ...
    if (a.ENVIRONMENT) if ("WEB" === a.ENVIRONMENT) ja = !0; else if ("WORKER" === a.ENVIRONMENT) fa = !0; else if ("NODE" === a.ENVIRONMENT) qa = !0; else if ("SHELL" === a.ENVIRONMENT) za = !0; else throw Error("Module['ENVIRONMENT'] value is not valid. must be one of: WEB|WORKER|NODE|SHELL.");
    ...
    if (a.buffer) var D = a.buffer; else "object" === typeof WebAssembly && "function" === typeof WebAssembly.Memory ? (a.wasmMemory = new WebAssembly.Memory({initial: A / 65536}), D = a.wasmMemory.buffer) : D = new ArrayBuffer(A), a.buffer = D;
    r();
    E[0] = 1668509029;
    Ja[1] = 25459;
    ...
    (function () {
        ...
        function b(b, e, d) {
            ...
            a.wasmBinary || "function" !== typeof WebAssembly.instantiateStreaming || Y(f) || "function" !== typeof fetch ? S(g) : WebAssembly.instantiateStreaming(fetch(f, {credentials: "same-origin"}), h).then(g).catch(function (c) {
        ...
        a.asm = function (c, e, d) {
            if (!e.table) {
                ...
                e.table = "object" === typeof WebAssembly && "function" === typeof WebAssembly.Table ? void 0 !== f ? new WebAssembly.Table({
                    ...
                    maximum: f,
                    element: "anyfunc"
                }) : new WebAssembly.Table({initial: p, element: "anyfunc"}) : Array(p);
                a.wasmTable = e.table
            }
    ...
    Sa = !0;
    a.wasmTableSize = 476;
    a.wasmMaxTableSize = 476;
    a.asmGlobalArg = {};
    a.asmLibraryArg = {
        abort: O, assert: f, enlargeMemory: function () {
            var e = a.usingWasm ? 65536 : 16777216, c = 2147483648 - e;
        ...
        }, __ZSt18uncaught_exceptionv: v, ___cxa_allocate_exception: function (a) {
            return Ka(a)
            ...
            return a
        }, ___cxa_find_matching_catch: la, ___cxa_pure_virtual: function () {
            oa = !0;
            ...
            Ha++;
            return 0
        }, _pthread_once: ma, _pthread_setspecific: function (a, c) {
